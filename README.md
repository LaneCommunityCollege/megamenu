...
When you're ready to deploy your MegaMenu, run `gulp default` and then run `python ./build.py`. This will generate the updated css sheets via SASS and the minified HTML from html.html, then replace both those variables to generate lmm.js. lmm.js is then minified and written as lmm.dev.js. 
